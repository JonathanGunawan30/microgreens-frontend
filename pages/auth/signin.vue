                            ...
                            <div class="flex flex-col gap-3">
                                <div class="w-full">
                                    ...
                                    <input type="email"
                                        ...
                                        id="formSigninEmail" placeholder="Email Address" v-model="email" required />
                                    ...
                                    <div class="password-field relative">
                                        ...
                                        <div class="password-field relative">
                                            <input :type="showPassword ? 'text' : 'password'"
                                                class="form-control border border-gray-300 text-gray-900 rounded-lg focus:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] focus:ring-green-600 focus:ring-0 focus:border-green-600 block p-2.5 px-3 disabled:opacity-50 disabled:pointer-events-none w-full text-base fakePassword"
                                                id="formSigninPassword" placeholder="Password" v-model="password" required />
