  ...
  <div class="container">
    ...
    <div class="grid grid-cols-1">
      <div class="card h-full card-lg">
            ...
            <table class="text-left w-full whitespace-nowrap table-with-checkbox table-hover">
              ...
              <tbody>
                <tr v-if="customerStore.loading">
                    <td colspan="4" class="text-center py-4 text-gray-500">Loading data...</td>
                </tr>
                <tr v-else-if="customerStore.error">
                    <td colspan="4" class="text-center py-4 text-red-500">{{ customerStore.error }}</td>
                </tr>
                ...
                <tr v-else v-for="item in customers" :key="item.id">
                  ...
                  <td class="py-3 px-24 text-left">{{ item.email }}</td>
        ...
        <div v-if="pagination?.total_count > 0" class="border-t border-gray-300 flex flex-col md:flex-row justify-between items-center px-6 py-6 gap-3">
