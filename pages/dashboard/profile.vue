              ...
              <form @submit.prevent="handleProfileSubmit">
                <div class="mb-8 flex flex-col sm:flex-row items-center gap-6 p-6 border border-green-100 rounded-2xl bg-green-50/30">
                  ...
                  <div class="text-center sm:text-left">
                    ...
                    <button type="button" class="btn btn-sm bg-green-600 text-white hover:bg-green-700 transition-all px-4 py-2 rounded-lg font-bold shadow-sm shadow-green-200" @click="$refs.fileInput.click()">
                ...
                <div class="mb-8 p-5 border border-gray-200 rounded-lg bg-gray-50">
                  <div class="flex justify-between items-center mb-3 flex-wrap gap-2">
                    ...
                    <div class="flex items-center gap-2">
                      <button
type="button" class="btn btn-sm bg-gray-900 hover:bg-black/90 text-white border-none py-1.5 px-3 rounded inline-flex items-center gap-1 transition"
                          @click="openMapModal">
                        <Icon name="tabler:map-pin" size="16" />
                        Pick from Map
                      </button>
                      <button
type="button" :disabled="isLocating" class="btn btn-sm bg-white border border-gray-300 text-gray-700 hover:bg-gray-100 py-1.5 px-3 rounded inline-flex items-center gap-1 transition disabled:opacity-50"
                          @click="getCurrentLocation">
                        <Icon v-if="isLocating" name="tabler:loader-2" size="16" class="animate-spin" />
                        <Icon v-else name="tabler:current-location" size="16" />
...
name="tabler:map-pin" size="16"
                    ...
                    <button
type="button" :disabled="isGeocoding || !formData.address" class="btn btn-sm bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 text-xs py-1.5 px-3 rounded inline-flex items-center gap-1 transition disabled:opacity-50"
                        @click="syncAddressToMap">
                      <Icon v-if="isGeocoding" name="tabler:loader-2" size="12" class="animate-spin" />
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col">
          ...
          <div class="p-4 border-b bg-white flex flex-col gap-2">
            ...
            <div class="flex gap-2">
              <input
v-model="tempLocation.address" type="text" readonly
          ...
          <div id="admin-location-map" class="w-full h-[400px] z-0"/>
