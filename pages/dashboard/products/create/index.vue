        ...
        <div class="card card-lg border-0 row-span-4 col-span-2">
          <div class="card-body flex flex-col gap-8 p-7">
            <div class="flex flex-col gap-4">
              ...
              <form class="grid grid-cols-12 gap-6" novalidate @submit.prevent="handleSubmit">
                ...
                <div class="lg:col-span-6 col-span-12">
                  ...
                  <select v-model="form.unit" required class="border border-gray-300 text-gray-900 rounded-lg focus:ring-green-600 focus:border-green-600 block p-2 px-3 w-full">
                ...
                <div class="lg:col-span-12 col-span-12">
                  ...
                  <textarea v-model="form.description" class="border border-gray-300 text-gray-900 rounded-lg focus:ring-green-600 focus:border-green-600 block p-2 px-3 w-full min-h-[100px]" placeholder="Write description here..." required/>
                </div>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content p-6 flex flex-col gap-6">
          ...
          <div class="modal-body p-0">
            <form class="grid grid-cols-12 gap-4">
              ...
              <div class="col-span-12">
                ...
                <input type="file" class="border border-gray-300 rounded-lg block p-2 px-3 w-full" accept="image/*" @change="handleFileUpload" >
          ...
          <div class="flex flex-row gap-3 pt-4 border-t">
            <button type="button" class="btn bg-green-600 text-white hover:bg-green-700" @click="addVariant">Add Variant</button>
